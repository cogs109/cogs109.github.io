...
title: 💯 Exams
nav_order: 4
description: Exam dates, format, and policies for COGS 109.
---
...
* **Exam 1** — Monday, **Oct 19**
* **Exam 2** — Monday, **Nov 9**
* **Exam 3** — Wednesday, **Dec 2**
* **Elective final** — Wednesday, **Dec 9**, 9-11am @ COA 130
...
Sections will be used for (1) review of course material (teaching staff will walk through exam practice questions) and (2) open homework help/project work/office hours.
...
**Please note** that I do not curve exams. I strive to write fair exams that test knowledge taught in class, and offer many practice problems that are representative of what's on the exam. The historic median on my exams is **~75%** (widely regarded in psychometrics as a healthy score for a fair exam), and there are always students who score 100%. Despite this exam average, the course's final average grade is typically a **B or B+.**
...
In this course, you have the **option** of completing a group project OR taking a traditional, sit-down final exam.

If you choose not to complete the group project, you'll take a sit-down final exam (40 multiple-choice questions, 3 free-response questions) at the time scheduled by the registrar.

**You must decide between the two options by Week 3** of the course (when we start sorting project groups). In cases where a group member is not contributing to their group's project, they may be removed from the project and asked to complete the final exam instead.
