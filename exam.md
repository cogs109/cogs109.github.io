...
Each in-class exam is **50 minutes** and **closed-note**, with:
...
TAs run **exam review during discussion section** in the weeks before Exams 1 and 2 (see the [course calendar]({{ site.baseurl }}/#course-calendar)).
...
You choose between **the group project** and **a traditional sit-down final exam** — you do not do both. The elective final is 40 multiple-choice questions and 3 free-response questions, at the time scheduled by the registrar (Wednesday, Dec 9, 9-11am @ COA 130).

{: .important }
**You must decide between the two options by Week 3**, when we start sorting project groups. If a group member is not contributing to their group's project, they may be removed from the project and asked to complete the final exam instead.
